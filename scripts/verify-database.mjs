...
try {
  const requiredTables = [
    ...
    'curriculum.course_catalogues',
    'curriculum.course_catalogue_entries',
    'curriculum.requirement_sets',
    'curriculum.requirement_clauses',
    'curriculum.requirement_evaluations',
    'curriculum.requirement_evaluation_results',
    ...
    'registration.override_authorizations',
    'registration.request_override_usages',
    'registration.waitlist_terms',
    'registration.waitlist_expirations',
    'registration.capacity_pools',
    'registration.capacity_entitlements',
    'registration.request_capacity_assignments',
    'registration.confirmed_item_allocations',
    'registration.add_drop_requests',
    'registration.add_drop_manifest_items',
    'registration.add_drop_eligibility_snapshots',
    'registration.add_drop_override_usages',
    'registration.add_drop_capacity_assignments',
    'registration.add_drop_decisions',
    'registration.add_drop_allocation_events',
    ...
    'finance.accounts',
    'finance.account_student_links',
    'finance.fee_structures',
    'finance.fee_structure_lines',
    'finance.governed_demands',
    'finance.demand_allocations',
    'finance.postings',
    'finance.ledger_entries',
    'finance.provider_events',
    'finance.receipts',
    'finance.reconciliation_batches',
    'finance.reconciliation_approvals',
    'finance.refund_requests',
    'finance.refund_decisions',
    'finance.refunds',
    'migration.batches',
    ...
    'admissions.document_checklists',
    'admissions.document_checklist_items',
    'admissions.document_attachments',
    ...
    'admissions.seat_matrices',
    'admissions.seat_categories',
    'admissions.seat_slots',
    'admissions.seat_reservations',
    'admissions.offer_seat_reservations',
    'admissions.seat_releases',
    'admissions.seat_conversions',
    ...
    'student.withdrawal_requests',
    'student.withdrawal_decisions',
    'student.programme_enrolment_withdrawals',
