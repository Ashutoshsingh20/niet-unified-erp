...
try {
  ...
  const required = [
    ...
    '/api/v1/curriculum/catalogues',
    '/api/v1/curriculum/catalogues/{id}',
    '/api/v1/curriculum/catalogues/{id}/publication',
    '/api/v1/curriculum/requirement-sets',
    '/api/v1/curriculum/requirement-sets/{id}',
    '/api/v1/curriculum/requirement-sets/{id}/publication',
    '/api/v1/curriculum/requirement-evaluations',
    '/api/v1/curriculum/requirement-evaluations/{id}',
    ...
    '/api/v1/finance/fee-structures/{id}/publication',
    '/api/v1/finance/fee-structures/{id}/demands',
    ...
    '/api/v1/admissions/seat-matrices',
    '/api/v1/admissions/seat-matrices/{id}/publication',
    '/api/v1/admissions/seat-matrices/{id}/reservations',
    '/api/v1/admissions/seat-matrices/{id}/availability',
    '/api/v1/admissions/merit-lists',
    '/api/v1/admissions/merit-lists/{id}',
    '/api/v1/admissions/merit-lists/{id}/publication',
    '/api/v1/admissions/conversion-exceptions',
    '/api/v1/admissions/conversion-exceptions/scan',
    '/api/v1/admissions/conversion-exceptions/{id}/resolution',
    ...
    '/api/v1/registration/add-drop/requests',
    '/api/v1/registration/add-drop/requests/{id}/decision',
  ];
